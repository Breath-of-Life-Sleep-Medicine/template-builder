...
test("empty form", () => {
  let expected = {
    ...
    pulse_min:          "0",
    pulse_max:          "0",
    s_duration_min:     "0.0 minutes",
    s_ahi:              "0.0",
    snore_min:          "0.0 minutes",
    snore_min_60db:     "0.0 minutes",
    snore_min_45db:     "0.0 minutes",
    tst_deep:           "0.00",
    // calculated
    trt:                "0 minutes",
    od_percent:         "0.0",
    s_duration_percent: "0.0",
    snore_percent:      "0.0",
    cahi_percent:       "0",
    // misc
    afib:               "detected; total duration: 0 seconds",
  };
