...
data[key].clean = {
  ...
  // titration portion
  "ti_trt":             () => clip_minutes(ti_trt.value),             // total recording time (minutes)
  "ti_tst":             () => clip_minutes(ti_tst.value),             // total sleep time (minutes)
  "ti_eff":             () => clip_percent(ti_eff.value),             // sleep efficiency
  "ti_lat":             () => clip_minutes(ti_lat.value),             // sleep latency
  "ti_rem_duration":    () => clip_minutes(ti_rem_duration.value),    // REM duration (minutes)
  "ti_rem":             () => clip_percent(ti_rem.value),             // REM (% TST)
...
data[key].template_set = {
  ...
  // titration portion
  "ti_start": () => time_24_to_12(ti_start.value), // start time
  "ti_end":   () => time_24_to_12(ti_end.value),   // end time
};